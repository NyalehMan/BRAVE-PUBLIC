  ...
  <div class="fire-incidents-page">
    <div class="page-header">
      <div>
        ...
        <p>Manage all flood incidents pulled from ArcGIS WebMap.</p>
      </div>
      ...
      <div class="header-actions">
        ...
        <button class="btn btn-danger" type="button" @click="$router.push('/flood-list/add')">
...
async function deleteIncident(incident) {
  ...
  try {
    ...
    if (!deleteResult || deleteResult.error) {
      console.error('Delete result:', deleteResult)

        ...
        <div class="map-area">
          ...
          <div v-if="showUpdateReportTool" class="update-report-panel custom-update-panel">
            ...
            <div class="custom-update-body">
              ...
              <template v-else-if="updateMode === 'create'">
                ...
                <select v-model="createForm.categories">
          ...
          <div class="map-tool-dock">
            ...
            <button
              type="button"
              class="map-tool-btn"
              :class="{ active: showLocationTool }"
              title="Location Tool"
              @click="toggleLocationTool"
            >
            ...
            <button
              type="button"
              class="map-tool-btn"
              :class="{ active: showDirectionsTool }"
              title="Directions"
              @click="toggleDirectionsTool"
            >
            ...
            <button
              type="button"
              class="map-tool-btn"
              :class="{ active: showUpdateReportTool }"
              title="Update Report"
              @click="toggleUpdateReportTool"
            >
              <FeatherIcon icon="edit-3" />
            </button>
            ...
            <button
              type="button"
              class="map-tool-btn"
              :class="{ active: showBookmarkTool }"
              title="Bookmark Area"
              @click="toggleBookmarkTool"
            >
...
async function handleMapClick(event) {
  ...
  if (showUpdateReportTool.value && createLocationSelecting.value) {
